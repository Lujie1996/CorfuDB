...
class UFOStoreTestImpl {
     ...
     */
    @Nonnull
    public UFOTxnTestImpl txn(@Nonnull final String namespace) {
        return new UFOTxnTestImpl(corfuStore.txn(namespace));
    }
     ...
     */
    @Nonnull
    public UFOTxnTestImpl txn(@Nonnull final String namespace, IsolationLevel isolationLevel) {
        return new UFOTxnTestImpl(corfuStore.txn(namespace, isolationLevel));
    }
